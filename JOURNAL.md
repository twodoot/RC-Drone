...
I also realised that the ESP version of the arduino nano can only handle 3.3 volts through its logic pins and luckily the MPU-6050 functions on 3.3 volts so I rewired it to have it be powerd by the 3.3 volt pin on the nano.
